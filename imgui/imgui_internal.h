...
public:
    ...
    ImRect      TitleBarRect() const                    { return (Collapsed && (Flags & ImGuiWindowFlags_CollapseHorizontal)) ? ImRect(Pos, ImVec2(Pos.x + TitleBarHeight(), Pos.y + SizeFull.y)) : ImRect(Pos, ImVec2(Pos.x + SizeFull.x, Pos.y + TitleBarHeight())); }

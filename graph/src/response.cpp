...
{
    return { CELL_ERASED, k.first , "", "", k.second, false };
}

Response Response::InputErased(const CellKey& k)
{
    return { INPUT_DELETED, k.first , "", "", k.second, false };
}

Response Response::OutputErased(const CellKey& k)
{
    return { OUTPUT_DELETED, k.first , "", "", k.second, false };
}

Response Response::InstanceErased(const Env& env, const InstanceIndex& i)
{
    return { INSTANCE_ERASED, env , "", "", i, false };
}
